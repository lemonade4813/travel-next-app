...
export default function Signup(){
    ...
    const {register, watch, formState : {errors}} = useForm<any>({mode : "onChange"})
        ...
        <div className="absolute w-[400px] h-[120px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        ...
                        <form className="flex flex-col items-center justify-center">
                            ...
                            <div className="mb-8 group"> 
                                    ...
                                    <input {...register("password", {pattern : {value : /^(?=.*[A-Za-z])(?=.*[0-9]|.*[!@#$%^&*()_+{}\[\]:;<>,.?~\\/-]).{10,}$|^(?=.*[0-9])(?=.*[!@#$%^&*()_+{}\[\]:;<>,.?~\\/-]).{10,}$/, message : '영문자, 숫자, 특수문자 중 2종류 이상을 포함하고 최소 10자 이상이어야 합니다.'}})}className="shadow-lg border-solid border-pink-400 border-2 w-[240px] h-12 rounded-lg"/>
